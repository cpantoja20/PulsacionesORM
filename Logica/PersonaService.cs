...
namespace Logica
{
    public class PersonaService
    {
        ...
        public string Modificar(Persona personaNueva)
        {
            try
            {
                ...
                if (personaVieja != null)
                {
                    ...
                    _context.SaveChanges();
                    return ($"El registro {personaNueva.Nombre} se ha modificado exitosamente");
                }
                else
                {
        ...
        {
            return _context.Personas.Count(p => p.Sexo == "Femenino");
        }
        public int TotalizarHombres()
        {
            return _context.Personas.Count(p => p.Sexo == "Masculino");
        }
    }
